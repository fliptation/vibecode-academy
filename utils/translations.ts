...
export const translations = {
  en: {
    ...
    who4Desc: "Your developers are your biggest investment. Give them the right AI tools and watch productivity multiply. The ROI is immediate and measurable.",
  ...
  de: {
    ...
    who4Desc: "Deine Entwickler sind dein grösstes Investment. Mit den richtigen KI-Tools multipliziert sich ihre Produktivität. Der ROI ist sofort messbar.",
